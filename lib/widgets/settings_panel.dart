...
class _SettingsPanelState extends State<SettingsPanel> {
  ...
  Widget _buildSetAsDefaultButton() {
    return ListTile(
      ...
      title: const Text('Marcar como Predeterminado', style: TextStyle(color: Colors.white)),
  ...
  void _confirmSetAsDefault() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          '¿Estás seguro de marcar esta configuración como predeterminada?',
